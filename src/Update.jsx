...
export default function Update(props) {
  const [formData, setFormData] = React.useState(props.personToUpdate);
  ...
  function handleSubmit(event) {
    ...
    props.updatePerson(formData);
  }

  return (
    <div className={props.darkMode ? "add-dark" : "add"}>
      <p className="add--title">Kontakt bearbeiten</p>
